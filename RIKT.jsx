...
<div className="requirements-container">
  ...
  <div className="requirement-card">
    ...
    <a href="/registration" className="register-button">Register here</a>
  </div>
</div>
      {/* ▲▲▲ END OF NEW SECTION ▲▲▲ */}
      {/* ▼▼▼ Contact Us Section ▼▼▼ */}
  ...
  <div className="contact-icons">
    ...
    <img src="/public/facebookmono.png" alt="Facebook" className="contact-icon" /></a>
    <a href="https://www.instagram.com/rmitshinsei/" target="_blank" rel="noopener noreferrer">
    <img src="/public/instamono.png" alt="Instagram" className="contact-icon" /></a>
  </div>
</div>
...
>>>>>>> 0c934bc781facbfbec810e78a75f817c7826ead4
}
